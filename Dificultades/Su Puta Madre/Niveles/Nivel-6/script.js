...
const enemyCinco = document.getElementById("enemy-cinco");
const enemySeis = document.getElementById("enemy-seis");
...
enemyCinco.addEventListener("mouseover", (e) => {
  alert("Game Over");
  nivel = 1;
  puntos = 0;
  tiempo = 60;
...
enemySeis.addEventListener("mouseover", (e) => {
  alert("Game Over");
  nivel = 1;
  puntos = 0;
  tiempo = 60;
...
function moverEnemyCinco() {
  randNum = Math.round(Math.random() * 600);
  randNum2 = Math.round(Math.random() * 600);
  document.getElementById("enemy-cinco").style.marginTop = randNum + "px";
  document.getElementById("enemy-cinco").style.marginLeft = randNum2 + "px";
}

function moverEnemySeis() {
  randNum = Math.round(Math.random() * 600);
  randNum2 = Math.round(Math.random() * 600);
  document.getElementById("enemy-seis").style.marginTop = randNum + "px";
  document.getElementById("enemy-seis").style.marginLeft = randNum2 + "px";
}
...
setInterval(moverEnemyUno, 500);
setInterval(moverEnemyDos, 500);
setInterval(moverEnemyTres, 500);
setInterval(moverEnemyCuatro, 500);
setInterval(moverEnemyCinco, 500);
setInterval(moverEnemySeis, 500);
