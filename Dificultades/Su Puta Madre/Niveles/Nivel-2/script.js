...
setInterval(moverEnemyUno, 300);
setInterval(moverEnemyDos, 300);
setInterval(moverEnemyTres, 300);
setInterval(moverEnemyCuatro, 300);
setInterval(moverEnemyCinco, 300);
