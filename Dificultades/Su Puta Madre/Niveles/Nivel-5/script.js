...
setInterval(restarTiempo, 900);
setInterval(moverEnemyUno, 200);
setInterval(moverEnemyDos, 200);
setInterval(moverEnemyTres, 200);
setInterval(moverEnemyCuatro, 200);
setInterval(moverEnemyCinco, 200);
